...
public class List<T extends Comparable<T>> implements ListInterface<T>{
    ...
    public void setFront(T dados){
        T a = dados;
        insereFront(a);
    }
    //Metodo que seta no final
    public void setRear(T dados){
        T a = dados;
        insereRear(a);
    }
    //Metodo que seta em qualquer posicao
    public void setPosicao(T dados, int posicao){
        T a =dados;
        inserePosicao(a,posicao);
    }
    //Insere no inicio
    private void insereFront(T dados){
        No<T> newNo = new No<T>(dados); // cria um novo no
    ...
    //Insere no final
    private void insereRear(T dados){
        No<T> newNo = new No<T>(dados); // cria um novo no
        if(this.head == null){//se a lista estiver vazia
            head = newNo;;
            tail = newNo;
    ...
    private void inserePosicao(T dados, int posicao){
